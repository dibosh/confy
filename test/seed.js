module.exports = {
  "docs": [
    ...
    {"_id":"orgs/confy","name":"Confy","email":"admin@confy.io","type":"org","owner":"pksunkara","plan":"none","users":{"pksunkara":2,"whatupdave":1,"vanstee":1}},
    {"_id":"orgs/confy/projects/knowledgebase","name":"KnowledgeBase","description":"Wiki & FAQ support","type":"project","teams":{"all":true,"consultants":true},"org":"confy"},
    {"_id":"orgs/confy/projects/main","name":"Main","description":"Main app","type":"project","teams":{"all":true,"engineering":true},"org":"confy"},
    {"_id":"orgs/confy/projects/urlshortener","name":"UrlShortener","description":"Service to be used by bots","type":"project","teams":{"all":true,"engineering":true},"org":"confy"},
    {"_id":"orgs/confy/teams/all","name":"All","description":"Owners","type":"team","users":{"pksunkara":true},"org":"confy"},
    {"_id":"orgs/confy/teams/consultants","name":"Consultants","description":"Consultants will have restricted access to the projects","users":{"whatupdave":true,"vanstee":true},"org":"confy","type":"team"},
