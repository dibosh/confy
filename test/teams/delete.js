  ...
  return {
    'Teams': {
      ...
      'Deleting team with owner': {
        topic: function () {
          macro.delete('/orgs/confy/teams/engineering', {}, {user: 'pksunkara', pass: 'password'}, this.callback);
        },
        'should return 204': macro.status(204),
        'should not return the team': function (err, res, body) {
          assert.isUndefined(body);
        },
        'should delete team doc and it': macro.nodoc('orgs/confy/teams/engineering', 'deleted'),
        'should update project doc and it': macro.doc('orgs/confy/projects/main', {
        ...
        'should update org doc and it': macro.doc('orgs/confy', {
          'should decrement the count for the user': function (err, body) {
      ...
      'Deleting team with member': {
        topic: function () {
          macro.delete('/orgs/confy/teams/consultants', {}, {user: 'vanstee', pass: 'password'}, this.callback);
        },
        ...
        'should not delete team doc and it': macro.doc('orgs/confy/teams/consultants')
      },
      'Deleting team with no access': {
        topic: function () {
          macro.delete('/orgs/confy/teams/consultants', {}, {user: 'jsmith', pass: 'secret'}, this.callback);
        },
        'should return 404': macro.status(404),
        'should return not found': function (err, res, body) {
          assert.deepEqual(body, {message: 'Not found'});
